...
import 'package:chatt_app/groupinfo.dart';
import 'package:chatt_app/messegetile.dart';
...
class _ChatPageState extends State<ChatPage> {
  ...
  getChatandAdmin() {
    ...
    Databaseservice(FirebaseAuth.instance.currentUser!.uid).getGroupAdmin(widget.groupId).then((val) {
      setState(() {
        admin = val;
      });
    });
